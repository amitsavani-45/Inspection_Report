  ...
  return (
    <div className="selection-container">
      <div className="selection-header">
        ...
        <h2 className="selection-title">Scrap Note</h2>
        <p className="selection-subtitle">Scrap Note records management</p>
      </div>

      <div className="selection-cards-wrapper">
        <div className="select-card fill-data-card" onClick={() => navigate('/scrap-note-form')}>
          <div className="select-icon-wrapper">
            <i className="bi bi-pencil-square select-icon"></i>
          </div>
          <h3>Fill Data</h3>
          <p>Enter new Scrap Note record</p>
        ...
        <div className="select-card print-data-card" onClick={() => navigate('/scrap-note-view"')}>
          ...
          <h3>View Reports</h3>
          <p>View, filter and print Scrap Notes</p>
          <div className="select-arrow"><i className="bi bi-arrow-right"></i></div>
        </div>
      </div>
    </div>
...
export default ScrapNoteSelection;